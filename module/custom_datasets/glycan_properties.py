...
@R.register("datasets.GlycanProperties")
class GlycanPropertiesDataset(torch_data.Dataset, core.Configurable):
    """
    Glycan Properties Dataset with 3 Tasks.
    ...
    md5 = "a876d2fd66f776a9380fe16703bfb064"
    target_fields = ["immunogenicity", "inferred_origin", "link"]       
