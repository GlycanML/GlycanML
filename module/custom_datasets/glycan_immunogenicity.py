...
@R.register("datasets.GlycanImmunogenicity")
class GlycanImmunogenicityDataset(torch_data.Dataset, core.Configurable):
    """
    Glycan Immunogenicity Dataset for binary classification of glycan immunogenicity.
    ...
    Parameters:
        ...
        **kwargs
    """
    url = "https://torchglycan.s3.us-east-2.amazonaws.com/downstream/glycan_immunogenicity.csv"
